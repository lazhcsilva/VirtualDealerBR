...
public class ConcessionariaService {
	...
	public boolean salvarConcessionaria(Concessionaria concessionaria)throws ServiceException, MessagingException {
		...
		if (this.findConcessionariaByEmail(concessionaria.getEmailConcessionaria()) != null) {
			...
			throw new ServiceException("Já existe uma concessionaria com este e-mail");
		
		} else if (this.findConcessionariaByCnpj(concessionaria.getCnpj()) != null) {
		
			throw new ServiceException("Já existe uma concessionaria com este CNPJ");
	...
	public Concessionaria logarConcessionaria(String emailConcessionaria, String password) throws ServiceException, NoSuchAlgorithmException, UnsupportedEncodingException {	
		
		String senhaCriptografada = Util.criptografarSenha(password);
		Concessionaria concessionaria = this.concessionariaDAO.logarConcessionaria(emailConcessionaria, senhaCriptografada);
